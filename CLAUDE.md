...
│   ├── test_exec_summary_stream.py  # Session 32 — SSE event contract: cache-hit instant emit, agent events forwarded, single terminal done, JSON parse fallback, error forwarding (4 tests)
├── scripts/
