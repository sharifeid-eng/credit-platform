...
**2026-04-12 repeat:** Happened again with `/notebooklm` — added 4 backend endpoints but forgot the nginx rule. Production showed "Package not installed" because the status call returned HTML. This is now the #1 production deployment gotcha.
