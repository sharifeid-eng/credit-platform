...
$backendCmd = "Set-Location '$root'; Write-Host '  [Backend] Starting FastAPI on localhost:8000...' -ForegroundColor Cyan; & '$root\venv\Scripts\activate.ps1'; python -m uvicorn backend.main:app --reload"
